                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="http://localhost/mapache/angel6.html" style="color: #000;">practica 6</a><br>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarNavDropdownMenuLink"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="http://localhost/mapache/angel7.HTML" style="color: #000;">practica 7</a><br>
                            <a class="dropdown-item" href="http://localhost/mapache/angel8.html" style="color: #000;">practoca 8</a><br>
                            <a class="dropdown-item" href="http://localhost/mapache/angel9.html" style="color: #000;">Practoca 9</a><br>
                        </div>
                    </li>
                </ul>
            </div>
...
<link href="https://fonts.cdnfonts.com/css/noto-serif-display" rel="stylesheet">
       ...
       <div class="jumbotron">
       <h1>ESCUELAS SECUNDARIAS TECNICAS </h1>
